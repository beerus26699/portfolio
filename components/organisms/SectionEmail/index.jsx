    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                console.log('Message fail: ' + resData.message);
            }
        } catch (error) {
        ...
        >
            ...
            <div className="z-10">
                ...
                <div className="socials flex flex-row gap-4">
                    <Link href="https://github.com/beerus26699" target="_blank">
                        <GithubIcon className="w-10 h-10 hover:opacity-80" />
                    </Link>
                    <Link
                        href="https://www.linkedin.com/in/nguyen-hai-0685a2216/"
                        target="_blank"
                    >
                        <LinkedinIcon className="w-10 h-10 text-[#0077B5] hover:opacity-80" />
                    </Link>
                    <Link
                        href="https://www.facebook.com/nguyenvanhai.zozin/"
                        target="_blank"
                    >
                    ...
                    <form className="flex flex-col" onSubmit={handleSubmit}>
                        <div className="mb-6">
                            ...
                            <input
                                ...
                                placeholder="amy.pham@gmail.com"
                            />
                        </div>
                        <div className="mb-6">
                            <label
